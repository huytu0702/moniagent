...
class AIInteraction(Base):
    ...
    user_id = Column(String, ForeignKey("users.id"), nullable=True)  # Optional, unauthenticated users
    session_id = Column(String, nullable=True)  # To group related interactions
    interaction_type = Column(String, nullable=False)  # e.g., "invoice_processing", "categorization", "advice"
